    ...
    <div id="content" class="app-content">
        <div class="d-flex align-items-center mb-3">
            <div>
                ...
                <h1 class="page-header mb-0">Edit Project</h1>
            </div>
            <div class="ms-auto">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $project->Title }}" class="form-control" name="title" placeholder="Project Title">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Summary</label>
                                    <input type="text" value="{{ $project->meta }}" class="form-control" name="meta" placeholder="Project Summary">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group date" id="datepicker-disabled-past"
                                        ...
                                        <input type="text" value="{{ $project->start }}" class="form-control" placeholder="Select Start Date "
                                            name="date" />
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group date" id="datepicker-disabled-pastb"
                                        data-date-format="yyyy-mm-dd" data-date-start-date="Date.default">
                                        <input type="text" value="{{ $project->End }}" class="form-control" placeholder="Select End Date "
                                            name="date1" />
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault"
                                            {{ $project->status == 1 ? 'checked' : '' }} name="status"/>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault"
                                           {{ $project->popular == 1 ? 'checked' : '' }} name="pop">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-control p-0 overflow-hidden">
                                    <textarea class="summernote" name="descr">{!! $project->Descr !!}</textarea>
                                </div>
                            </div>
                            <div class="">
                                <div class="mb-3">
