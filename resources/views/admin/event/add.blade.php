        ...
        <div class="d-flex align-items-center mb-3">
            <div>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:;">Add blog post</a></li>
                </ol>
                <h1 class="page-header mb-0">Add blog post</h1>
            </div>
            <div class="ms-auto">
        ...
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Add blog post</h4>
                </div>
                <div class="panel-body">
                    ...
                    <form action="{{ url('admin/event') }}" method="post" class="tab-content panel rounded-0 p-3 m-0" enctype="multipart/form-data">
                        @csrf
                        <!-- BEGIN nav-tabs -->
                        ...
                        <div class="tab-content panel rounded-0 p-3 m-0">
                            ...
                            <div class="tab-pane fade active show" id="default-tab-1">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-2 ">
                                            <label class="form-label col-form-label col-md-3">Start </label>
                                     ...
                                     <div class="col-md-3">
                                        <div class="mb-2 ">
                                            ...
                                            <div class="input-group bootstrap-timepicker">
                                                <input id="timepicker2" type="text" class="form-control" name="end" />
                                                <span class="input-group-text input-group-addon">
                                                    <i class="fa fa-clock"></i>
                                                    <span>
                                            </div>
