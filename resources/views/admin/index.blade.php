            ...
            <div class="col-xl-12">
                ...
                <ul class="nav nav-tabs nav-tabs-inverse nav-justified" data-sortable-id="index-2">
                    ...
                    <li class="nav-item"><a href="#purchase" data-bs-toggle="tab" class="nav-link"><i
                                class="fa fa-archive fa-lg me-5px"></i> <span class="d-none d-md-inline">Latest
                                Cause</span></a></li>
                    <li class="nav-item"><a href="#email" data-bs-toggle="tab" class="nav-link"><i
                                class="fa fa-envelope fa-lg me-5px"></i> <span class="d-none d-md-inline">Subscribers</span></a>
                    </li>
                </ul>
                            ...
                            <div class="h-300px p-3" data-scrollbar="true">
                                ...
                                <div class="d-sm-flex">
                                    <a href="javascript:;" class="w-sm-200px">
                                        <img class="mw-100 rounded" src="{{ $item->getFirstMediaUrl('blog', 'tinythumb') }}"
                                            alt="" />
                                    </a>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <h6><a href="javascript:;" class="text-dark text-decoration-none"><br /></a>
                                            </h6>
                                        </td>
